			...
			<section className="flex min-h-0 flex-1 flex-col items-center justify-end overflow-y-auto pb-5">
				...
				<div className="mt-5 grid w-full max-w-[310px] grid-cols-3 items-center">
					...
					<ActionButton
						layout="iconOnly"
						size="large"
						className="mx-auto size-16 rounded-full bg-bg-positive-solid text-primary-foreground hover:bg-bg-positive-solid-pressed active:bg-bg-positive-solid-pressed disabled:bg-bg-positive-solid/40 disabled:[--seed-icon-color:var(--seed-color-palette-static-white)]"
